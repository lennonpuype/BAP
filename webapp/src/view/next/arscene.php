...
<a-marker type='pattern' url='./assets/ar/data/pattern-sticker.patt' name="0" class="marker 0">
  <a-entity gltf-model="#gltf4" light="type: ambient; color: #BBB" scale=".02 .02 .02" animation-mixer></a-entity>
</a-marker>

<a-marker type='pattern' url='./assets/ar/data/pattern-1.patt' name="1" class="marker 1">
  <a-entity gltf-model="#gltf4" light="color: #AFA; intensity: .2" scale=".02 .02 .02" animation-mixer></a-entity>
</a-marker>

<a-marker type='pattern' url='./assets/ar/data/pattern-2.patt' name="2" class="marker 2">
  <a-entity gltf-model="#gltf4" light="type: ambient; color: rgba(255,255,255,.3)" scale=".02 .02 .02" animation-mixer></a-entity>
</a-marker>

<a-marker type='pattern' url='./assets/ar/data/pattern-3.patt' name="3" class="marker 3">
  <a-entity gltf-model="#gltf4" light="type: ambient; color: #FFF" scale=".02 .02 .02" animation-mixer></a-entity>
</a-marker>

<a-marker type='pattern' url='./assets/ar/data/pattern-4.patt' name="4" class="marker 4">
  <a-entity gltf-model="#gltf4" light="color: #FFF; intensity: 1.5" scale=".02 .02 .02" animation-mixer></a-entity>
</a-marker>
