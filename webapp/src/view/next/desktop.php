...
<main>
  ...
  <section class="routes_section">
    ...
    <article class="route_preview sporen_route" data-aos="fade-up">
...
<footer>
      ...
      <section class="rights">
        <p class="rights-title"> &copy 2020 - All rights reserved</p>
      </section>
...
<footer>
      ...
      <section class="rights">
        <p class="rights-title"> &copy 2020 - Tous droits réservés</p>
      </section>
